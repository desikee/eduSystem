...
@section('script')
    <script src="/assets/app/js/student/complete.js" type="text/javascript"></script>
@endsection
                            ...
                            <div class="form-group m-form__group row align-items-center">
                                    ...
                                    <div class="m-form__group m-form__group--inline">
                                        ...
                                        <div class="m-form__control">
                                            <select class="form-control m-bootstrap-select m-bootstrap-select--solid u-search-select" name="company" id="u-search-select-company">
                                                ...
                                                @if(isset($search_select['company']))
                                ...
                                <div class="col-md-4">
                                    <div class="m-input-icon m-input-icon--left">
                                        <input type="text" class="form-control m-input m-input--solid" placeholder="搜索学员..." id="m_form_search">
