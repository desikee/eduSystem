...
@section('script')
    <script src="/assets/app/js/system/user.js" type="text/javascript"></script>
@endsection
...
@section('content')
                            ...
                            <div class="form-group m-form__group row align-items-center">
                                ...
                                {{--<div class="col-md-3">--}}
                                    {{--<div class="m-input-icon m-input-icon--left">--}}
                                        {{--<input type="text" class="form-control m-input m-input--solid" placeholder="搜索用户..." id="u-search-general">--}}
    ...
    <div class="modal fade" id="u-modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="m-form m-form--fit m-form--label-align-right" id="u-modal-from">
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-4">
                                    <span class="form-control">默认为： idreamsky</span>
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <label for="company" class="col-2 col-form-label">
                                    公司名称
                                </label>
                                <div class="col-10">
                            ...
                            <div class="form-group m-form__group row">
                                <label for="parent_id" class="col-2 col-form-label">
                                    指定上级
                                </label>
                                <div class="col-10">
                                    <input class="form-control m-input" type="text" name="parent_id" id="parent_id">
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control m-input" type="text" name="role" id="role">
                                </div>
                            </div>
                        </div>
                    </form>
