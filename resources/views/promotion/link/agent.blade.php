...
@section('script')
<script src="/assets/app/js/link/agent.js" type="text/javascript"></script>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="u-modal-title">
                        新增
                    </h3>
                    ...
                    <form class="m-form m-form--fit m-form--label-align-right" id="u-modal-form">
                        <div class="m-portlet__body">
                            <div class="m-form__heading">
                                <h5 class="m-form__heading-title m--font-danger">
                                    以下信息创建之后无法修改
                                </h5>
                            </div>
                            ...
                            <div class="form-group m-form__group row">
                                <label for="user_id" class="col-3 col-formval(da-label">
                                    链接拥有人
                                </label>
                                <div class="col-8">
                                    <select class="form-control" name="user_id" id="u-form-user_id" style="width: 100%;">
